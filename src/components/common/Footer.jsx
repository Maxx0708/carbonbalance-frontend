        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ 
              ...
              <div style={{ marginBottom: '1px' }}>company</div>
              <div style={{ marginBottom: '1px' }}>community</div>
              <div>careers</div>
            </div>
          </div>
        ...
        <div style={{
          ...
          {['f', '🐦', '📷'].map((icon, index) => (
            <div key={index} style={{
              width: '24px',
              height: '24px',
              backgroundColor: index < 2 ? 'rgb(50, 195, 226)' : 'rgba(255, 255, 255, 0.2)',
              borderRadius: '3px',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
            ...
            >
              <span style={{ 
                color: 'white', 
                fontSize: icon === 'f' ? '14px' : '12px',
                fontFamily: icon === 'f' ? "'Arquitecta', sans-serif" : 'inherit',
                fontWeight: icon === 'f' ? '900' : 'normal'
              }}>{icon}</span>
            </div>
          ))}
        </div>
